...
# fungsi create_daily_orders_df() yang digunakan untuk menyiapkan daily_orders_df.
...
#Fungsi create_sum_order_items_df() bertanggung jawab untuk menyiapkan sum_orders_items_df
...
#Fungsi create_bygender_df() digunakan untuk menyiapkan bygender_df
...
#Fungsi create_byage_df() merupakan helper function yang digunakan untuk menyiapkan byage_df
...
#Fungsi create_bystate_df() digunakan untuk menyiapkan bystate_df.
...
#mengurutkan DataFrame berdasarkan order_dat
...
#Membuat dataframe baru dengan data yang telah difilter
main_df = all_df[(all_df["order_date"] >= str(start_date)) & 
                (all_df["order_date"] <= str(end_date))]



#Pemanggilan fungi yang telah kita create
...
# average RFM (Recency, Frequency, & Monetary)
